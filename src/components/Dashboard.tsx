...
export default function Dashboard() {
    ...
    return (
        <div className="flex h-dvh overflow-hidden">
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-surface/95 backdrop-blur-xl border-t border-border z-30 px-4 py-2 flex justify-around items-center rounded-t-2xl safe-area-bottom">
            ...
            {/* More Menu Overlay */}
            {moreMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-40" onClick={() => setMoreMenuOpen(false)}>
