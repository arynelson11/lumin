const url = "https://teuqyveifwuuuzpkitvo.supabase.co/rest/v1/investments?select=*&limit=1";
...
fetch(url, {
    ...
    .then(data => {
        if (data.length > 0) {
            ...
            return fetch("https://teuqyveifwuuuzpkitvo.supabase.co/rest/v1/investments", {
                method: "POST",
                headers: {
                    "apikey": apikey,
                    "Authorization": `Bearer ${apikey}`,
